...
namespace DAL.Seed
{
    public class TransactionSeed
    {
        public List<Transaction> GetSeed()
        {
            ...
            transaction1.Status = Models.Enum.TransactionStatus.Success;
            ...
            transaction2.Status = Models.Enum.TransactionStatus.Failed;
            ...
            transaction3.Status = Models.Enum.TransactionStatus.Failed;
            ...
            transaction4.Status = Models.Enum.TransactionStatus.Failed;
            ...
            transaction5.Status = Models.Enum.TransactionStatus.Failed;
            ...
            transaction6.Status = Models.Enum.TransactionStatus.Failed;
            ...
            transaction7.Status = Models.Enum.TransactionStatus.Failed;
            ...
            transaction8.Status = Models.Enum.TransactionStatus.Failed;
            ...
            transaction9.Status = Models.Enum.TransactionStatus.Failed;
